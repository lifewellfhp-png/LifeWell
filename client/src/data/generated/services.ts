...
//
// Phase 28 exception: six soft/unsupported-outcome-claim phrases (two
// "...for the best outcomes", one "...ensure optimal treatment", three
// "most effective way/path") were corrected both here and in
// _source/services.json, but a full `node scripts/generate-content.mjs`
// re-run was deliberately NOT performed. _source/services.json still
// holds the pre-Phase-2 "I/my"
// first-person voice; the site-wide "we/our" conversion (commit 0917dd6)
// was applied by hand directly to this generated file and never back-
// ported to source. Regenerating now would silently revert that voice
// fix (and any other undocumented drift) across the entire file. Until
// _source/services.json is brought back in sync with this file's actual
// content, any further correction here needs the same by-hand treatment,
// mirrored into _source/services.json for the record.
...
export const generatedServices: Service[] = [
  {
    ...
    "intro": [
      "A psychiatric evaluation is an essential first step in understanding your mental health and identifying a clear path forward. Whether you are experiencing anxiety, depression, difficulty focusing, mood changes, or sleep disturbances, a comprehensive evaluation helps clarify what you are experiencing and how it can be treated.",
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "text",
            "text": "When therapy is beneficial, we may recommend referral to a licensed therapist for additional support. Medication management and therapy can complement each other as part of a treatment plan."
          },
          {
            "type": "text",
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "type": "text",
            "text": "Annual physical exams help monitor your health and detect problems early—even before symptoms appear. Preventive care is an important way to help protect your long-term health and reduce the risk of serious illness."
          },
          {
            "type": "text",
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "text",
            "text": "Medication adjustments are made when necessary to help keep your treatment plan appropriate for you."
          },
          {
            "type": "text",
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "text",
            "text": "Early prevention is an important way to help protect your long-term health."
          }
        ]
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "text",
            "text": "Medication may be combined with lifestyle and health support as part of a well-rounded treatment approach."
          },
          {
            "type": "text",
