...
export function ServiceCard({
  ...
  return (
    <article className={cn('group relative flex h-full flex-col', className)}>
      ...
      >
        <h3 className="text-[20px] font-medium italic leading-[1.3] tracking-[-1px] text-[var(--lw-accent)] sm:max-desktop:text-[24px] desktop:text-[26px]">
          <Link
            href={service.href}
