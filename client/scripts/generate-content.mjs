...
// posts.ts carries one permanent, non-generated exception: 3 real articles
// were migrated out of this file into the CMS blog_posts table and must
// never be re-added by a future WordPress-snapshot regeneration.
const postsBannerNote = `//
